...
class MakeQuatationPhase1(IsEvaluator,View):
	...
	def post(self,request,enquiry_id,evaluation_id):
		...
		if language == 'ENGLISH':
			...
			message = "Dear Customer, Please find the Quotation against the cleaning at "+evaluationdetails.address.apartment+","+evaluationdetails.address.floor+","+evaluationdetails.address.street+","+evaluationdetails.address.building+","+evaluationdetails.address.avenue+","+evaluationdetails.address.block+","+evaluationdetails.address.area.name+","+evaluationdetails.address.governorate.name+" here http://15.206.173.198/customer/quatation/"+str(evaluation.id)+". For any assistance please contact us on +9651882707. Thank you for choosing Bleach Kuwait"
