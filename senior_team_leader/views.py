...
class StlHome(IsSeniorTeamLeader,View):
	def get(self,request):
		...
		starting_datetime = datetime.strptime('15-07-2021 06:00 AM','%d-%m-%Y %I:%M %p')
		changeschedulers   = OrderScheduler.objects.select_related('order_scheduler_book').filter(start_at__gte=starting_datetime)
		print(starting_datetime)
		print(changeschedulers)
