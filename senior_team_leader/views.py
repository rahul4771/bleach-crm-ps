...
class TicketDetails(IsSeniorTeamLeader,View):
	def get(self,request):
		...
		return render(request,'stl/ticket/tickets.html',{"tickets":tickets,"follow_ups_count":follow_ups_count,"follow_up_cleaning_count":follow_up_cleaning_count,"search_query":search})		
