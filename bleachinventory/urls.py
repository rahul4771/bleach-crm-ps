...
url(r'^inventory-transfer/$',views.InventoryTransfer.as_view(),name='inventory-transfer'),
url(r'^item-dispose/$',views.ItemDispose.as_view(),name='item-dispose'),
url(r'^pendingitems/$',views.PendingItems.as_view(),name='pending-items'),
