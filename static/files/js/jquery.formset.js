...
;(function($) {
    $.fn.formset = function(opts)
    {
        ...
        if ($$.length) {
            ...
            if ($$.is('TR')) {
                ...
                $$.filter(':last').after('<div class="' + options.addCssClass + '"><a href="javascript:void(0)">' + options.addText + '</a></div>');
    ...
    $.fn.formset.defaults = { 
        ...
        addCssClass: 'add-address',          // CSS class applied to the add link
