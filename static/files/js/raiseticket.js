  ...
  console.log(investigators_list,"il")
        ...
        removeFromSelect(){
          ...
          async submitForm(){
              ...
              if(actiontypes.includes('Payback')){
                ...
                //   for(var j = 0 ; j<this.payback.length;j++){
                //       console.log(this.payback[j])
                //       if(this.payback[j]== 'Service Quality'){
                //           var a = {
                //             category:this.payback[j],
                //             items:this.paybackSer
                //           }
                //           p.push(a);
                //       }
                //       if(this.payback[j]== 'Damage'){
                //           var a = {
                //             category:this.payback[j],
                //             items:this.paybackDam
                //           }
                //           p.push(a);
                //       }
                //       if(this.payback[j]== 'Other'){
                //           var a = {
                //             category:this.payback[j],
                //             items:this.paybackOther
                //           }
                //           p.push(a);
                //       }
                //   }
