  ...
  template: `
    <div class="row kitchen-box p-4">
      ...
      <div class="col-md-12 d-flex">
        ...
        <v-radio-group class="p-2" row v-model="$root.floorCabinetCleaning[floorIndex]">
          <v-radio :value="true">
      ...
      <div class="col-md-12 d-flex">
        <v-radio-group row required v-model="$root.floorKitchenCondition[floorIndex]">
      ...
      <div class="col-md-6">
        <v-select v-model="$root.floorKitchenSize[floorIndex]" :items="sizeOptions" label="Size"></v-select>
      </div>

      <div class="col-md-6">
        <div class="d-flex">
          <div style="margin-top: 16px; padding-top: 4px;">Oil Residue? <span style="color:red">*</span></div>
          <v-radio-group class="p-2" row v-model="$root.floorOilResidue[floorIndex]">
            <v-radio :value="true">
              <template v-slot:label>
                <div>Yes<strong class="success--text"></strong></div>
              </template>
