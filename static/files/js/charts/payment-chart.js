google.charts.load('current',{
    ...
    function drawChart() {
        ...
        var quotes = [['Date', 'Payments'],
                        [new Date(2020,08,10),1250],
                        [new Date(2020,08,15),4000],
                        [new Date(2020,08,18),3500],
                        [new Date(2020,08,20),2000],
                        [new Date(2020,08,25),8400],
                        [new Date(2020,08,30),5600]];
        var quotations = google.visualization.arrayToDataTable(quotes);
