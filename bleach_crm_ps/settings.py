...
CRONJOBS = [ 
    ...
    # ('*/1 0 * * *', 'customer.cron.invoice_amount_updations', '>> ' + os.path.join(BASE_DIR,'log/debug9.log' + ' 2>&1 ')),
    # ('*/1 1 * * *', 'customer.cron.bank_charge_add', '>> ' + os.path.join(BASE_DIR,'log/debug10.log' + ' 2>&1 ')),
