...
urlpatterns = [
		...
		url(r'^resources-management/$',views.ResourceManagementAPIView.as_view(),name='resource-management-api'),
    ...
    url(r'^v1/productivity/$',views.StagingProductivity.as_view(),name='staging-productivity'),
    url(r'^v1/productivity/get-service-types/$', views.ProductivityServiceTypeAPIView.as_view(), name='get-service-types'),
    ...
    url(r'^v1/productivity/get-service-groups/$', views.ServiceGroupAPIView.as_view(), name='get-service-groups'),
    ...
    url(r'^v1/booking/(?P<evaluation_detail_id>[-\w]+)/$',views.StagingBooking.as_view(),name='v1-booking'),
    url(r'^v1/dynamic/get-service-types/$',views.StagingBookingAPIView.as_view(),name='get-service-types'),      
    url(r'^get-service-types/$', views.ServiceTypeAPIView.as_view(), name='get-service-types-api'),
    url(r'^save-employee-skills/$', views.SaveEmployeeSkillsAPIView.as_view(), name='save-employee-skills'),
    url(r'^get-employee-skills/$', views.EmployeeSkillsAPIView.as_view(), name='get-employee-skills'),
	]
