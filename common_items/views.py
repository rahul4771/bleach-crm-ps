...
class ClientOrderDetails(IsAuthenticated,View):
	def get(self,request,order_id):
		...
		return render(request,"common/client/order-page.html",{"invoice":invoice,"order":order,"client_details":client_details,"active_orders_count":active_orders_count,"total_orders_count":total_orders_count,"average_feedback":average_feedback,})
