...
function initialize() {
    ...
    function drawBars() {
        ...
        $.ajax({
            url: "/order-data/quotation_data_policy",
            data: {
            ...
            var quotations = [['Month', 'One Time Services', 'Subscriptions']];
            ...
            $.each(data_month,function(key,value){
                ...
                quotations.push([monthNames[value.date],value.onetime_qt,value.subscription_qt]);
                submitted_total_month += parseInt(value.onetime_qt);
                approved_total_month += parseInt(value.subscription_qt);
            });
            }else{
                quotations.push(['',0,0]);
            }
    ...
    function drawArea() {
        ...
        $.ajax({
            ...
            var quotations_area = [['Date', 'One Time Cleaning', 'Subscription']];
            ...
            $.each(data_date,function(key,value){
                ...
                quotations_area.push([ord_date,value.onetime_qt,value.subscription_qt]);
                console.log(quotations_area,"qts_test2")
                submitted_total += parseInt(value.onetime_qt);
                approved_total += parseInt(value.subscription_qt);
            });
            }else{
