...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        try:
            ...
            evaluation = Evaluation.objects.get(evaluation_id='BLC20250810020')
            order = Order.objects.get(evaluation__evaluation_id='BLC20250810020')
            ...
            order_scheduler_books = EvaluationBook.objects.filter(id__in=[18593])

            # Define schedule times
            start_datetime = datetime.strptime('06/08/2025 08:00 AM', '%d/%m/%Y %I:%M %p')
