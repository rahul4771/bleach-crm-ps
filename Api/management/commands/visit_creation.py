...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        try:
            ...
            evaluation = Evaluation.objects.get(evaluation_id='BLC20250510017')
            order = Order.objects.get(evaluation__evaluation_id='BLC20250510017')
            ...
            order_scheduler_books = EvaluationBook.objects.filter(id__in=[17570])

            # Define schedule times
            start_datetime = datetime.strptime('07/05/2025 11:00 AM', '%d/%m/%Y %I:%M %p')
