...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        subscriptions = Order.objects.select_related('evaluation__customer').filter(evaluation__quatation_status='APPROVED',evaluation__payment_method='SUBSCRIPTION',payment_status='PENDING',subscription_topay__gt=0).exclude(order_status='ORDER_CANCELLED')
        print(subscriptions)
