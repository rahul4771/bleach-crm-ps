...
class UserProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model  = UserProfile
        fields = ('id','name','gender','email','nationality','date_day','date_month','date_year','customer_type','company','job_title','mobile_number','phone_number','sms_preference','is_whatsapp','is_email','is_sms')   
...
class ShiftScheduleSerializer(serializers.ModelSerializer):
    ...
    shift3_end_at   = serializers.DateTimeField(required=False,input_formats=["%d-%m-%Y %I:%M %p"])
    class Meta:
        model = ShiftSchedule
...
class AddressSerializer(serializers.ModelSerializer): 
    ...
    class Meta: 
        model  = Address 
        fields = ('id','governorate','location','area','block','avenue','building','street','floor','apartment','currently_active') 
...
class ServiceAddOnsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model   = ServiceAddOns
        fields  = ('id','service_type','price','category','name','size','productivity','category_updated','category_updated_maximum','category_updated_minimum')
