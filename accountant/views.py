...
def export_users_xls(request):
	...
	if report_type == 'xeroinvoices':
		...
		xeroinvoices = XeroInvoice.objects.filter(is_active=True,created__range=(prev_date_start,todate_date_end),is_paid=True).values_list('created','order__order_no', 'payment_policy','amount').order_by('-id')
