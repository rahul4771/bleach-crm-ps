...
class OrderDetails(IsTechnicalSupervisor,View):
	def get(self,request):
...
class TicketDetails(IsTechnicalSupervisor,View):
	def get(self,request):
		...
		return render(request,'technicalsupervisor/ticket/tickets.html',{"tickets":tickets,"follow_ups_count":follow_ups_count,"follow_up_cleaning_count":follow_up_cleaning_count,"search_query":search,"page_range":page_range,"entry_per_page":entry_per_page,"no_of_entries":no_of_entries,"governorates":governorates,"areas":areas,"investigators":investigators,"fil_governorate":fil_governorate,'fil_area':fil_area,"fil_investigator":fil_investigator,"fil_status":fil_status,})


class ClientOrderDetails(IsTechnicalSupervisor,View):
	def get(self,request,order_id):
		...
		return render(request,"technicalsupervisor/client/order-page.html",{"order":order,"client_details":client_details,"active_orders_count":active_orders_count,"total_orders_count":total_orders_count,"average_feedback":average_feedback,})


class ClientOrders(IsTechnicalSupervisor,View):
	def get(self,request,client_id):
		...
		return render(request,"technicalsupervisor/client/client-page.html",{"client_details":client_details,"orders":orders,"active_orders_count":active_orders_count,})

class TicketAdvanced(IsTechnicalSupervisor,View):
	def get(self,request,client_id,followup_id):
		...
		return render(request,'technicalsupervisor/ticket/followup-page.html',{"client_details":client_details,"active_orders_count":active_orders_count,"total_orders_count":total_orders_count,"followup_details":followup_details,})		