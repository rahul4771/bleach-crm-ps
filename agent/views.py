...
class CleaningCallendar(APIView):
	...
	def get(self,request):
		...
		calendar_order_schedules        = OrderScheduler.objects.filter(id__in=calendar_order_schedules_list).select_related('evaluation_details__evaluator').prefetch_related('cleaning_team_order_scheduler__team_leader')
		print(calendar_order_schedules,"schedules")
