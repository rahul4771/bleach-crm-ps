...
class UserProfileForm(forms.ModelForm):
	class Meta:
		model  = UserProfile
		fields = ('name','name_arabic','gender','email','nationality','customer_type','company','job_title','mobile_number','phone_number','date_day','date_month','date_year','sms_preference','is_credit')	
