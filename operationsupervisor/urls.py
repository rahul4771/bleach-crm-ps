...
urlpatterns = [
	...
	url(r'^orders/$',views.OrderDetails.as_view(),name='op-supervisor-orders'),
	url(r'^order-details/(?P<order_id>[-\w]+)$',views.ClientOrderDetails.as_view(),name='op-supervisor-order-details'),
	url(r'^client/orders/(?P<client_id>[-\w]+)$',views.ClientOrders.as_view(),name='op-supervisor-client-orders'),
