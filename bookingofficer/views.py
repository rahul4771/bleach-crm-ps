...
from bleach_crm_ps.permissions import IsBookingOfficer
...
class AdminHome(IsBookingOfficer,View):
	...
	def post(self,request):
		...
		return redirect('/booking-officer/dashboard/?cleaning_calendar_date='+cleaning_calendar_date+'&evaluation_calendar_date='+evaluation_calendar_date)


class ActiveSubscriptions(IsBookingOfficer,View):
	def get(self,request):
		#subscriptions
		...
		return render(request,'bookingofficer/subscription/active_subscriptions.html',{"search_query":search,"page_range":page_range,"entry_per_page":entry_per_page,"no_of_entries":no_of_entries,"subscriptions":subscriptions})
	...
	def post(self,request):
		...
		return redirect('booking-officer:bookingofficer-active-subscriptions')

class ClientDetails(IsBookingOfficer,View):
	def get(self,request):
		...
		return render(request,'bookingofficer/client/clients.html',{"client_details":client_details,"search_query":search,"new_clients_count":new_clients_count,"page_range":page_range,"entry_per_page":entry_per_page,"no_of_entries":no_of_entries,"governorates":governorates,"areas":areas,"fil_governorate":fil_governorate,"fil_area":fil_area,"fil_customertype":fil_customertype,"fil_status":fil_status})		

class ClientOrders(IsBookingOfficer,View):
	def get(self,request,client_id):
		...
		return render(request,"bookingofficer/client/client-page.html",{"client_details":client_details,"orders":orders,"active_orders_count":active_orders_count,})

class ClientOrderDetails(IsBookingOfficer,View):
	def get(self,request,order_id):
		...
		return render(request,"bookingofficer/client/order-page.html",{"order":order,"invoice":invoice,"client_details":client_details,"active_orders_count":active_orders_count,"total_orders_count":total_orders_count})
	...
	def post(self,request,order_id):
		...
		return redirect('booking-officer:cancell-order',order_id)

class MakeQuatationDuplicate(IsBookingOfficer,View):
	...
	def get(self,request,evaluation_id):
		...
		return redirect('booking-officer:bookingofficer-makequatation1duplicateedit',new_evaluation.customer.id,new_evaluation.id,)


class MakeQuatationPhase1DuplicateEdit(IsBookingOfficer,View):	
	...
	def get(self,request,enquiry_id,evaluation_id):
		...
		return render(request,'bookingofficer/enquiry/phase1quatationduplicateedit.html',{'enquiry_user':enquiry_user,'evaluation':evaluation,'evaluation_details':evaluation_details,"allow_submit":allow_submit,"active_orders_count":active_orders_count,"total_orders_count":total_orders_count,})	
...
class TicketDetails(IsBookingOfficer,View):
	def get(self,request):
		...
		return render(request,'bookingofficer/ticket/tickets.html',{"tickets":tickets,"follow_ups_count":follow_ups_count,"follow_up_cleaning_count":follow_up_cleaning_count,"search_query":search,"page_range":page_range,"entry_per_page":entry_per_page,"no_of_entries":no_of_entries,"governorates":governorates,"areas":areas,"investigators":investigators,"fil_governorate":fil_governorate,'fil_area':fil_area,"fil_investigator":fil_investigator,"fil_status":fil_status,})		


class TicketAdvanced(IsBookingOfficer,View):
	def get(self,request,client_id,followup_id):
		...
		return render(request,'bookingofficer/ticket/followup-page.html',{"client_details":client_details,"active_orders_count":active_orders_count,"total_orders_count":total_orders_count,"followup_details":followup_details,})


class OrderDetails(IsBookingOfficer,View):
	def get(self,request):
		...
		return render(request,'bookingofficer/order/orders.html',{"evaluations":evaluations,"evaluators":evaluators,"approved_orders_count":approved_orders_count,"pending_orders_count":pending_orders_count,"search_query":search,"page_range":page_range,"entry_per_page":entry_per_page,"no_of_entries":no_of_entries,"governorates":governorates,"areas":areas,"service_types":service_types,"fil_governorate":fil_governorate,"fil_area":fil_area,"fil_status":fil_status,"fil_cleaning_policy":fil_cleaning_policy,"fil_service_type":fil_service_type,"fil_payment_policy":fil_payment_policy,"fil_evaluator":fil_evaluator})		

class CustomerBookingsList(IsBookingOfficer,View):
	def get(self,request):
...
class FeedbackAdvanced(IsBookingOfficer,View):
	def get(self,request,client_id,order_id):
		...
		return render(request,'bookingofficer/feedback/feedback-page.html',{"order":order,"client_details":client_details,"feedback_details":feedback_details,"active_orders_count":active_orders_count,"total_orders_count":total_orders_count,"other_feedbacks":other_feedbacks,"average_feedback":average_feedback,})




class ResourceManagement(IsBookingOfficer,View):
	def get(self,request):
...
class TicketApprove(IsBookingOfficer,View):
	def get(self,request,paybackdiscount_id):
		...
		try:
			paybackdiscount = PaybackDiscount.objects.prefetch_related(Prefetch('paybackdiscount_details',queryset=PaybackDiscountDetails.objects.filter(is_active=True),to_attr='paybackdiscountdetails')).get(id=int(paybackdiscount_id),is_active=True)
		except:
			paybackdiscount = None

		return render(request,'bookingofficer/ticket/ticket-approval.html',{"paybackdiscount":paybackdiscount})
	...
	def post(self,request,paybackdiscount_id):
		...
		if option == 'PAYBACK':
			...
			PaybackDiscount.objects.filter(id=paybackdiscount_id).update(approved_option=option,approved_by=request.user,approved_total_cost=request.POST.get('approved_total_cost'),is_completed=True,accountant_notes=request.POST.get('notes'))
		...
		if option == 'DISCOUNT':
			...
			order_id      =  paybackdiscount.investigation.order.id
			evaluation_id =  paybackdiscount.investigation.order.evaluation.id
...
class PromocodeView(IsBookingOfficer,View):
	...
	def get(self,request):
		...
		return render(request,'bookingofficer/promocode/promo.html',{'promo_codes':promo_codes,'active_promocodes_count':active_promocodes_count,'used_coupons_count':used_coupons_count,})
	...
	def post(self,request):
		...
		return redirect('booking-officer:bookingofficer-promocode')		
...
def cleaningcalendardate(request):
	...
	data['cleaningdetails'] = render_to_string('bookingofficer/home/cleaning-calendar-snippet.html',context)	
...
def evaluationcalendardate(request):
	...
	data['evaluationdetails'] = render_to_string('bookingofficer/home/evaluation-calendar-snippet.html',context)
	return JsonResponse(data)

class AdminPaymentEdit(IsBookingOfficer,View):
	...
	def get(self,request,enquiry_id,evaluation_id):
		...
		return render(request,'bookingofficer/payment/payment_edit.html',{'enquiry_user':enquiry_user,'evaluation':evaluation,'evaluation_details':evaluation_details,"allow_submit":allow_submit,"active_orders_count":active_orders_count,"total_orders_count":total_orders_count,})	
	...
	def post(self,request,enquiry_id,evaluation_id):
		...
		return redirect('booking-officer:bookingofficer-client-orderdetails',order.id)
...
def deleteservice(request,book_id,evaluation_detail_id):
	...
	return redirect('booking-officer:bookingofficer-makequatation2edit',evaluation_detail_id)
...
class MakeQuatationPhase1Edit(IsBookingOfficer,View):	
	...
	def get(self,request,enquiry_id,evaluation_id):
		...
		return render(request,'bookingofficer/enquiry/phase1quatationedit.html',{'enquiry_user':enquiry_user,'evaluation':evaluation,'evaluation_details':evaluation_details,"allow_submit":allow_submit,"active_orders_count":active_orders_count,"total_orders_count":total_orders_count,})	
...
class MakeQuatationPhase2Delete(IsBookingOfficer,View):
	def post(self,request,evaluation_detail_id):
		...
		if not updated_evaluation.evaluation_details.exists():
			...
			return redirect('booking-officer:bookingofficer-orders')

		return redirect('booking-officer:bookingofficer-makequatation1edit',enquiry_id,evaluation_id)		

class OrderCancellation(IsBookingOfficer,View):
	def get(self,request,order_id):
...
class CashCollect(IsBookingOfficer,View):
	def get(self,request):
		return render(request,'bookingofficer/payment/cash-collect.html',{})
	def post(self,request):
		...
		return redirect('booking-officer:bookingofficer-cashcollect')


class FineWriteBack(View):
	def get(self,request):
		return render(request,'bookingofficer/payment/finewriteback.html',{})
	def post(self,request):
		order_id  = request.POST.get('order_id')
		order     = Order.objects.get(id=order_id)
